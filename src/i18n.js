// ============================================
// EQRA — Internationalization (i18n)
// ============================================
...
const translations = {
  bn: {
    ...
    navAbout: 'সম্পর্কে',
    navUmrah: 'উমরাহ',
    navUnderstandQuran: 'কুরআন ৫০%',
    understandQuranTitle: 'কুরআনের ৫০% ও ৬৫% শব্দভাণ্ডার শিক্ষা',
    ...
    // Quran
    quranTitle: 'আল-কুরআন',
    quranSubtitle: '১১৪টি সূরা — আরবি, বাংলা ও ইংরেজি অনুবাদ',
    surahWord: 'সূরা',
    ayahWord: 'আয়াত',
    ayahPlural: 'আয়াত',
    juzWord: 'পারা',
    makkiWord: 'মাক্কী',
    madaniWord: 'মাদানী',
    readSurah: 'সূরা পড়ুন',
    
    // Display modes
    displayArabicOnly: 'আরবি',
    ...
    audioPause: 'বিরতি',
    audioNext: 'পরবর্তী',
    audioPrev: 'পূর্ববর্তী',
    
    // Hadith
    hadithTitle: 'হাদিস',
    hadithSubtitle: 'সহীহ বুখারী ও সহীহ মুসলিম',
    hadithNarrator: 'বর্ণনাকারী',
    hadithGrade: 'মান',
    hadithReference: 'রেফারেন্স',
    ...
    footerCopyright: '© ২০২৬ EQRA। সকল স্বত্ব সংরক্ষিত।',
    ...
    // Quran Reading Goal & Streak
    readingGoal: 'কুরআন রিডিং গোল ও স্ট্রিক',
    streakTitle: 'দৈনিক স্ট্রিক',
    streakDays: 'দিন স্ট্রিক',
    streakBest: 'সর্বোচ্চ রেকর্ড',
    todayProgress: 'আজকের অগ্রগতি',
    targetCompleted: 'আজকের লক্ষ্য সম্পন্ন!',
    quickLog: 'দ্রুত লগ করুন',
    log5Ayahs: '+৫ আয়াত',
    log1Page: '+১ পৃষ্ঠা (২০ আয়াত)',
    markDoneToday: 'আজকের লক্ষ্য সম্পন্ন করেছি',
    activeGoalLabel: 'বর্তমান লক্ষ্য',
    choosePreset: 'প্রিসেট লক্ষ্যসমূহ',
    customGoalLabel: 'কাস্টম লক্ষ্য তৈরি করুন',
    streakActive: 'স্ট্রিক সক্রিয়',
    streakGrace: 'আজকের তিলাওয়াত বাকি আছে',
    weeklyTracker: 'সাপ্তাহিক ট্র্যাকার',
    monthlyHeatmap: 'মাসিক তিলাওয়াত হিস্ট্রি',
    khatamForecast: 'সম্ভাব্য খতমের সময়কাল',
    rewardHadith: 'কুরআন তিলাওয়াতের ফজিলত',
  ...
  en: {
    ...
    navAbout: 'About',
    navUmrah: 'Umrah',
    navUnderstandQuran: 'Understand 50%',
    understandQuranTitle: 'Understand 50% & 65% of the Holy Quran',
    ...
    // Quran
    quranTitle: 'Al-Quran',
    quranSubtitle: '114 Surahs — Arabic, Bangla & English Translation',
    surahWord: 'Surah',
    ayahWord: 'Ayah',
    ayahPlural: 'Ayahs',
    juzWord: 'Juz',
    ...
    // Hadith
    hadithTitle: 'Hadith',
    hadithSubtitle: 'Sahih al-Bukhari & Sahih Muslim',
    ...
    footerCopyright: '© 2026 EQRA. All rights reserved.',
    ...
    // Quran Reading Goal & Streak
    readingGoal: 'Quran Reading Goal & Streak',
    streakTitle: 'Daily Streak',
    streakDays: 'Days Streak',
    streakBest: 'Best Streak',
    todayProgress: "Today's Progress",
    targetCompleted: 'Goal Completed Today!',
    quickLog: 'Quick Log',
    log5Ayahs: '+5 Ayahs',
    log1Page: '+1 Page (20 Ayahs)',
    markDoneToday: 'Completed Goal Offline',
    activeGoalLabel: 'Active Goal',
    choosePreset: 'Preset Goals',
    customGoalLabel: 'Create Custom Goal',
    streakActive: 'Streak Active',
    streakGrace: 'Reading pending today',
    weeklyTracker: 'Weekly Tracker',
    monthlyHeatmap: 'Monthly Reading History',
    khatamForecast: 'Estimated Khatam Completion',
    rewardHadith: 'Virtues of Quran Recitation',
...
export function t(key, vars = {}) {
  let str = translations[currentLang]?.[key] || translations.bn[key] || key;
...
/** Set language and update HTML attributes */
export function setLang(lang) {
  if (!translations[lang]) return;
  currentLang = lang;
  document.documentElement.lang = lang;
  localStorage.setItem('eqra-lang', lang);
}

/** Initialize language from URL or storage */
export function initLang(lang) {
  const stored = localStorage.getItem('eqra-lang');
  const detected = lang || stored || 'bn';
  setLang(detected);
  return currentLang;
}

export default { t, getLang, setLang, initLang };
